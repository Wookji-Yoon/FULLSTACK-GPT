...
memory = ConversationSummaryBufferMemory(
    llm=llm, max_token_limit=60, return_messages=True, memory_key="chat_history"
)
...
if "chat_history" not in st.session_state:
    st.session_state["chat_history"] = [
        {"input": "", "output": "I'm ready! Ask anything about your file."}
    ]
    ...
    if new_message:
        ...
        with st.chat_message("ai"):
            ...
            st.session_state["chat_history"].append(
                {"input": new_message, "output": response}
            )
else:
    st.session_state["messages"] = [
        {"role": "ai", "message": "I'm ready! Ask anything about your file."}
